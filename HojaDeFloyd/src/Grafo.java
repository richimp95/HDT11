...
public class Grafo {
	...
	public String buscarRuta(String ciudad, String destino) {
	...
	public void Interrupcion(String ciudad1, String ciudad2){
		matrizAdjacencia[diccionario.indexOf(ciudad1)][diccionario.indexOf(ciudad2)]=999999999;
	}
	
	public void Crear(String ciudad1, String ciudad2,int distancia){
